...
namespace MercadoEnvio.Listado_Estadistico
{
    public partial class Estadistica : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            comboBox_Trimestre.Visible = true;
            comboBox_Trimestre.Visible = Enabled = true;
        ...
        private void button_Buscar_Click(object sender, EventArgs e)
        {
            ...
            if (tipoDeListado == "Vendedores con mayor cantidad de productos no vendidos")
            {
                ...
                String borrar = "IF OBJECT_ID('Class.usuarios_por_visibilidad', 'U') IS NOT NULL"
        ...
        private void comboBox_Trimestre_SelectedIndexChanged_1(object sender, EventArgs e)
        {
